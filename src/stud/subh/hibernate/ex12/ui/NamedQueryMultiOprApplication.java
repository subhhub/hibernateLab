package stud.subh.hibernate.ex12.ui;
...
import stud.subh.hibernate.ex12.dao.Employee;
import stud.subh.hibernate.ex12.dao.SessionUtil;

public class NamedQueryMultiOprApplication {
	public static void main(String[] args) {
		System.out.println("**HQL Named Query Multi DB Operations Application**");
